...
argocd/traefik            https://kubernetes.default.svc  traefik    default  Synced  Healthy  Auto-Prune  <none>      https://github.com/Hafflationist/gitops.git  argocd/traefik/localhost            main
